...
export class RegistrationComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private router: Router, private authService: AuthService) {
    ...
    this.formSubmit = this.formBuilder.group({
      ...
      inputPassword: ['', Validators.compose([Validators.required, Validators.maxLength(12)])],
      confirmPassword: ['', Validators.compose([Validators.required, Validators.maxLength(12)])]
    },
  ...
  submit(): void {
    ...
    this.authService.register(this.formSubmit.controls.inputEmail.value, this.formSubmit.controls.inputPassword.value);
